...
// domers/ui/node_modules/react/cjs/react.production.min.js
var require_react_production_min = __commonJS({
  "domers/ui/node_modules/react/cjs/react.production.min.js"(exports) {
    "use strict";
...
// domers/ui/node_modules/react/index.js
var require_react = __commonJS({
  "domers/ui/node_modules/react/index.js"(exports, module) {
    "use strict";
    if (true) {
...
// domers/ui/node_modules/scheduler/cjs/scheduler.production.min.js
var require_scheduler_production_min = __commonJS({
  "domers/ui/node_modules/scheduler/cjs/scheduler.production.min.js"(exports) {
    "use strict";
    function f(a, b) {
      var c = a.length;
      a.push(b);
...
// domers/ui/node_modules/scheduler/index.js
var require_scheduler = __commonJS({
  "domers/ui/node_modules/scheduler/index.js"(exports, module) {
    "use strict";
    if (true) {
...
// domers/ui/node_modules/react-dom/cjs/react-dom.production.min.js
var require_react_dom_production_min = __commonJS({
  "domers/ui/node_modules/react-dom/cjs/react-dom.production.min.js"(exports) {
    "use strict";
...
// domers/ui/node_modules/react-dom/index.js
var require_react_dom = __commonJS({
  "domers/ui/node_modules/react-dom/index.js"(exports, module) {
    "use strict";
    function checkDCE() {
...
// domers/ui/node_modules/react-dom/client.js
var require_client = __commonJS({
  "domers/ui/node_modules/react-dom/client.js"(exports) {
    "use strict";
...
// domers/ui/node_modules/react/cjs/react-jsx-runtime.production.min.js
var require_react_jsx_runtime_production_min = __commonJS({
  "domers/ui/node_modules/react/cjs/react-jsx-runtime.production.min.js"(exports) {
    "use strict";
    var f = require_react();
...
// domers/ui/node_modules/react/jsx-runtime.js
var require_jsx_runtime = __commonJS({
  "domers/ui/node_modules/react/jsx-runtime.js"(exports, module) {
    "use strict";
    if (true) {
...
function fallbackDomePoint(index, total) {
  ...
  const inRing = (normalized - ringStart) / Math.max(1e-3, ringEnd - ringStart);
...
function connectSimulatorStream() {
  ...
  socket.addEventListener("close", () => {
    ...
    if (simulatorStarted) {
      window.setTimeout(connectSimulatorStream, 1e3);
    }
  });
}
...
var init_main = __esm({
  async "domers/ui/main.mjs"() {
    ...
    hardwareDome = document.querySelector("#hardware-dome");
    hardwareStage = document.querySelector("#hardware-stage");
    activeVisualizer = document.querySelector("#dome-active-vis");
    flashSpeed = document.querySelector("#flash-speed");
    flashSpeedValue = document.querySelector("#flash-speed-value");
    domeTestPattern = document.querySelector("#dome-test-pattern");
    barTestPattern = document.querySelector("#bar-test-pattern");
    stageTestPattern = document.querySelector("#stage-test-pattern");
    ...
    configStageSideLengthsGrid = document.querySelector("#config-stage-side-lengths-grid");
    simVolume = document.querySelector("#sim-volume");
    simVolumeValue = document.querySelector("#sim-volume-value");
    ...
    sandboxVolume = document.querySelector("#sandbox-volume");
    sandboxVolumeValue = document.querySelector("#sandbox-volume-value");
    ...
    metricSimulatorFrames = document.querySelector("#metric-simulator-frames");
    previewDrawer = document.querySelector("#preview-drawer");
    canvas = document.querySelector("#dome-simulator");
    context = canvas?.getContext("2d");
    barSimulator = document.querySelector("#bar-simulator");
    stageSimulator = document.querySelector("#stage-simulator");
    isDedicatedSimulatorPage = document.body?.dataset.page === "simulator";
    SPECTRUM_CANVAS_SIZE = 750;
...
function VisualizerSelect({ id, name }) {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "config-section-grid output-config-grid", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "config-card", "aria-label": "Stage output config", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "config-field stage-side-lengths-editor", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { id: "config-stage-side-lengths", name: "configStageSideLengths", type: "hidden" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { id: "config-stage-side-lengths-summary", className: "side-lengths-summary", children: "no sides configured" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { id: "config-stage-side-lengths-grid", className: "side-lengths-grid", "aria-label": "Stage side lengths" })
          ] })
        ] })
      ] })
    ] }),
...
function RuntimeControls() {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { "aria-label": "Runtime Controls", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [
      "Flash speed",
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { id: "flash-speed", name: "flashSpeed", type: "range", min: "0", max: "8", step: "0.125", defaultValue: "0" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("output", { id: "flash-speed-value", htmlFor: "flash-speed", children: "0" })
    ] })
  ] });
}
function PaletteDrawer() {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("details", { id: "palette-drawer", "aria-label": "Palettes", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", { id: "palette-grid", "aria-label": "Palette colors", className: "palette-grid", "data-palette-editor": "64-entry-gradient" })
  ] });
}
function InputsDrawer() {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("details", { id: "inputs-drawer", "aria-label": "Inputs", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("summary", { children: "Inputs" }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("details", { id: "debug-visuals-drawer", "aria-label": "Debug Visuals", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", { id: "dome-test-pattern", name: "domeTestPattern", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "1", children: "Flash Colors" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "2", children: "Strut Iteration" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "3", children: "Strand Test" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "4", children: "Full Color Flash" })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [
      "Bar diagnostic",
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", { id: "bar-test-pattern", name: "barTestPattern", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "0", children: "Off" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "1", children: "Flash Colors" })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [
      "Stage diagnostic",
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", { id: "stage-test-pattern", name: "stageTestPattern", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "0", children: "Off" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "1", children: "Flash Colors" })
      ] })
    ] })
...
function SimulatorFrameView({ streamText }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { "aria-label": "Metrics", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { id: "stream-status", children: streamText }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
        "Engine frames: ",
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { id: "metric-frames", className: "metric", children: "0" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
        "Simulator frames: ",
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { id: "metric-simulator-frames", className: "metric", children: "0" })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { "aria-label": "Simulator", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("canvas", { id: "dome-simulator", width: "750", height: "750", "data-frame-source": "websocket" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: "Bar Simulator" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ol", { id: "bar-simulator", className: "device-list", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "none" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: "Stage Simulator" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ol", { id: "stage-simulator", className: "device-list", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "none" }) })
    ] })
  ] });
}
...
function SimulatorOnlyControls() {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { "aria-label": "Simulator-Only Controls", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("output", { id: "sandbox-volume-value", htmlFor: "sandbox-volume", children: "0.7" })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [
      "Beat phase preview",
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { id: "sandbox-beat-progress", name: "sandboxBeatProgress", type: "range", min: "0", max: "1", step: "0.01", defaultValue: "0.25" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("output", { id: "sandbox-beat-progress-value", htmlFor: "sandbox-beat-progress", children: "0.25" })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("fieldset", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "swatches", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [
          "Color 1",
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { id: "sandbox-palette-primary", name: "sandboxPalettePrimary", type: "color", defaultValue: "#00ff00" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [
          "Color 2",
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { id: "sandbox-palette-secondary", name: "sandboxPaletteSecondary", type: "color", defaultValue: "#0080ff" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [
          "Color 3 / flash",
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { id: "sandbox-palette-accent", name: "sandboxPaletteAccent", type: "color", defaultValue: "#ff4080" })
        ] })
      ] })
    ] })
  ] });
...
function App() {
  return document.body.dataset.page === "simulator" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SimulatorApp, {}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ControlApp, {});
}
